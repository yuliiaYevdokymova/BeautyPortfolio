export default function getEyeBrowsGalleryImages() {
  let images = [
    {
      original: require("../assests/EyeBrowsGallery/1.jpg"),
    },
    {
    ...
    {
      original: require("../assests/EyeBrowsGallery/6.JPG"),
    },
    {
      original: require("../assests/EyeBrowsGallery/7.JPG"),
    },
    {
